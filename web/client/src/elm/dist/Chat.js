			...
			case 'Send':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						_p4,
						{input: ''}),
					_1: A2(_elm_lang$websocket$WebSocket$send, _p1.server, _p3)
				};
			case 'NewEmoji':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						_p4,
						{
							input: A2(_elm_lang$core$Basics_ops['++'], _p3, _p2._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						_p4,
						{
							messages: {ctor: '::', _0: _p2._0, _1: _p1.messages}
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _user$project$Chat$emoji = _elm_lang$core$Native_Platform.incomingPort('emoji', _elm_lang$core$Json_Decode$string);
var _user$project$Chat$Model = F3(
	function (a, b, c) {
		return {server: a, input: b, messages: c};
	});
var _user$project$Chat$init = function (server) {
	return {
		ctor: '_Tuple2',
		_0: A3(
...
var _user$project$Chat$NewEmoji = function (a) {
	return {ctor: 'NewEmoji', _0: a};
};
var _user$project$Chat$subscriptions = function (_p5) {
	var _p6 = _p5;
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: A2(_elm_lang$websocket$WebSocket$listen, _p6.server, _user$project$Chat$NewMessage),
			_1: {
				ctor: '::',
				_0: _user$project$Chat$emoji(_user$project$Chat$NewEmoji),
				_1: {ctor: '[]'}
			}
		});
};
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('chat-message-input'),
					_1: {
						ctor: '::',
...
var _user$project$Chat$main = _elm_lang$html$Html$programWithFlags(
	{init: _user$project$Chat$init, view: _user$project$Chat$view, update: _user$project$Chat$update, subscriptions: _user$project$Chat$subscriptions})(_elm_lang$core$Json_Decode$string);
